...
class MyTest(unittest.TestCase):
    ...
    def test_254(self):  
        ...
        words = Words("12 East Main", address=True)
        self.assertEqual(words.words, [{'word': '12', 'tag': 27}, {'word': 'east', 'tag': 28}, {'word': 'main', 'tag': 29}])
        words = Words("12 West Main", address=True)
        self.assertEqual(words.words, [{'word': '12', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}])
        words = Words("12 North Main", address=True)
        self.assertEqual(words.words, [{'word': '12', 'tag': 27}, {'word': 'north', 'tag': 28}, {'word': 'main', 'tag': 29}])
        words = Words("12 South Main", address=True)
        self.assertEqual(words.words, [{'word': '12', 'tag': 27}, {'word': 'south', 'tag': 28}, {'word': 'main', 'tag': 29}])
        words = Words("12 E Main", address=True)
        self.assertEqual(words.words, [{'word': '12', 'tag': 27}, {'word': 'east', 'tag': 28}, {'word': 'main', 'tag': 29}])
        words = Words("12 W Main", address=True)
        self.assertEqual(words.words, [{'word': '12', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}])
        words = Words("12 N Main", address=True)
        self.assertEqual(words.words, [{'word': '12', 'tag': 27}, {'word': 'north', 'tag': 28}, {'word': 'main', 'tag': 29}])
        words = Words("12 S Main", address=True)
        self.assertEqual(words.words, [{'word': '12', 'tag': 27}, {'word': 'south', 'tag': 28}, {'word': 'main', 'tag': 29}])
        words = Words("12 e. Main", address=True)
        self.assertEqual(words.words, [{'word': '12', 'tag': 27}, {'word': 'east', 'tag': 28}, {'word': 'main', 'tag': 29}])
    ...
    def test_255(self):  
        ...
        words = Words("12 Northwest Main", address=True)
        self.assertEqual(words.words, [{'word': '12', 'tag': 27}, {'word': 'northwest', 'tag': 28}, {'word': 'main', 'tag': 29}])
        words = Words("12 Northeast Main", address=True)
        self.assertEqual(words.words, [{'word': '12', 'tag': 27}, {'word': 'northeast', 'tag': 28}, {'word': 'main', 'tag': 29}])
        words = Words("12 Southwest Main", address=True)
        self.assertEqual(words.words, [{'word': '12', 'tag': 27}, {'word': 'southwest', 'tag': 28}, {'word': 'main', 'tag': 29}])
        words = Words("12 Southeast Main", address=True)
        self.assertEqual(words.words, [{'word': '12', 'tag': 27}, {'word': 'southeast', 'tag': 28}, {'word': 'main', 'tag': 29}])
        words = Words("12 North west Main", address=True)
        self.assertEqual(words.words, [{'word': '12', 'tag': 27}, {'word': 'northwest', 'tag': 28}, {'word': 'main', 'tag': 29}])
        words = Words("12 North East Main", address=True)
        self.assertEqual(words.words, [{'word': '12', 'tag': 27}, {'word': 'northeast', 'tag': 28}, {'word': 'main', 'tag': 29}])
        words = Words("12 South West Main", address=True)
        self.assertEqual(words.words, [{'word': '12', 'tag': 27}, {'word': 'southwest', 'tag': 28}, {'word': 'main', 'tag': 29}])
        words = Words("12 South East Main", address=True)
        self.assertEqual(words.words, [{'word': '12', 'tag': 27}, {'word': 'southeast', 'tag': 28}, {'word': 'main', 'tag': 29}])
        words = Words("12 NW Main", address=True)
        self.assertEqual(words.words, [{'word': '12', 'tag': 27}, {'word': 'northwest', 'tag': 28}, {'word': 'main', 'tag': 29}])
        words = Words("12 NE Main", address=True)
        self.assertEqual(words.words, [{'word': '12', 'tag': 27}, {'word': 'northeast', 'tag': 28}, {'word': 'main', 'tag': 29}])
        words = Words("12 SW Main", address=True)
        self.assertEqual(words.words, [{'word': '12', 'tag': 27}, {'word': 'southwest', 'tag': 28}, {'word': 'main', 'tag': 29}])
        words = Words("12 SE Main", address=True)
        self.assertEqual(words.words, [{'word': '12', 'tag': 27}, {'word': 'southeast', 'tag': 28}, {'word': 'main', 'tag': 29}])
        words = Words("12 N.W. Main", address=True)
        self.assertEqual(words.words, [{'word': '12', 'tag': 27}, {'word': 'northwest', 'tag': 28}, {'word': 'main', 'tag': 29}])
        words = Words("12 N.E. Main", address=True)
        self.assertEqual(words.words, [{'word': '12', 'tag': 27}, {'word': 'northeast', 'tag': 28}, {'word': 'main', 'tag': 29}])
        words = Words("12 S.W. Main", address=True)
        self.assertEqual(words.words, [{'word': '12', 'tag': 27}, {'word': 'southwest', 'tag': 28}, {'word': 'main', 'tag': 29}])
        words = Words("12 S.E. Main", address=True)
        self.assertEqual(words.words, [{'word': '12', 'tag': 27}, {'word': 'southeast', 'tag': 28}, {'word': 'main', 'tag': 29}])
               
    def test_256(self):  
        """ Words - more address: num dir name """
        words = Words("the 12 se Main", address=True)
        self.assertEqual(words.words, [{'word': '12', 'tag': 27}, {'word': 'southeast', 'tag': 28}, {'word': 'main', 'tag': 29}])
        words = Words("the 12 se Main the", address=True)
        self.assertEqual(words.words, [{'word': '12', 'tag': 27}, {'word': 'southeast', 'tag': 28}, {'word': 'main', 'tag': 29}])
        words = Words("12 Main the", address=True)
        self.assertEqual(words.words, [])
        words = Words("the 12 se 1st", address=True)
        self.assertEqual(words.words, [{'word': '12', 'tag': 27}, {'word': 'southeast', 'tag': 28}, {'word': '1', 'tag': 29}])
        words = Words("the 12 se First", address=True)
        self.assertEqual(words.words, [{'word': '12', 'tag': 27}, {'word': 'southeast', 'tag': 28}, {'word': '1', 'tag': 29}])
    ...
    def test_270(self):
        ...
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'alabama', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops Alabama", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'alabama', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops, AK", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'alaska', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops Alaska", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'alaska', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops AZ", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'arizona', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops, Arizona", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'arizona', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops AR", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'arkansas', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops Arkansas", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'arkansas', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops CA", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'california', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops California", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'california', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops CO", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'colorado', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops Colorado", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'colorado', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops CT", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'connecticut', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops Connecticut", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'connecticut', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops DE", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'delaware', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops Delaware", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'delaware', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops DC", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'district of columbia', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops, D.C.", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'district of columbia', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops FL", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'florida', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops Florida", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'florida', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops GA", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'georgia', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops Georgia", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'georgia', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops HI", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'hawaii', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops Hawaii", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'hawaii', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops, Id.", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'idaho', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops, Idaho", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'idaho', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops IL", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'illinois', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops Illinois", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'illinois', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops IN", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'indiana', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops Indiana", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'indiana', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops IA", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'iowa', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops Iowa", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'iowa', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops KS", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'kansas', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops Kansas", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'kansas', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops KY", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'kentucky', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops, Kentucky", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'kentucky', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops LA", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'louisiana', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops Louisiana", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'louisiana', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops ME", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'maine', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops Maine", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'maine', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops, MD", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'maryland', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops MD", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'maryland', 'tag': 32}])
        ...
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'massachusetts', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops Massachusetts", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'massachusetts', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops MI", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'michigan', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops Michigan", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'michigan', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops MN", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'minnesota', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops Minnesota", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'minnesota', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops MS", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'mississippi', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops Mississippi", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'mississippi', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops MO", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'missouri', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops Missouri", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'missouri', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops MT", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'montana', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops Montana", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'montana', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops NE", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'nebraska', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops Nebraska", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'nebraska', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops NV", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'nevada', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops Nevada", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'nevada', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops NH", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'new hampshire', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops, New Hampshire", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'new hampshire', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops NJ", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'new jersey', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops, New Jersey", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'new jersey', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops NM", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'new mexico', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops, New Mexico", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'new mexico', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops NY", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'new york', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops, New York", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'new york', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops NC", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'north carolina', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops, North Carolina", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'north carolina', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops ND", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'north dakota', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops, North Dakota", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'north dakota', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops OH", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'ohio', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops, Ohio", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'ohio', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops PA", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'pennsylvania', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops, Pennsylvania", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'pennsylvania', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops RI", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'rhode island', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops, Rhode Island", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'rhode island', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops SC", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'south carolina', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops, South Carolina", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'south carolina', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops SD", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'south dakota', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops, South Dakota", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'south dakota', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops TN", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'tennessee', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops, Tennessee", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'tennessee', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops TX", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'texas', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops, Texas", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'texas', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops UT", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'utah', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops, Utah", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'utah', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops VT", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'vermont', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops, Vermont", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'vermont', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops VA", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'virginia', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops, Virginia", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'virginia', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops WA", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'washington', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops Washington", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'washington', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops WV", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'west virginia', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops, West Virginia", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'west virginia', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops WI", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'wisconsin', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops Wisconsin", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'wisconsin', 'tag': 32}])
        words = Words("12A W Main Ave., Hoops WY", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'hoops', 'tag': 31}, {'word': 'wyoming', 'tag': 32}])
    ...
    def test_273(self):
        ...
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'lake oswego', 'tag': 31}, {'word': 'oregon', 'tag': 32}])
        words = Words("12A W Main Ave., Lake Oswego OR", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'lake oswego', 'tag': 31}, {'word': 'oregon', 'tag': 32}])
        words = Words("12A W Main Ave., Oregon City, OR", address=True)
        self.assertEqual(words.words, [{'word': '12a', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'oregon city', 'tag': 31}, {'word': 'oregon', 'tag': 32}])
    ...
    def test_275(self):
        ...
        self.assertEqual(words.words, [{'word': '10', 'tag': 35}, {'word': 'seattle', 'tag': 31}, {'word': 'washington', 'tag': 32}])
        ...
        self.assertEqual(words.words, [{'word': '123', 'tag': 35}, {'word': 'seattle', 'tag': 31}, {'word': 'washington', 'tag': 32}])
        words = Words("POB 123 Seattle, WA", address=True)
        self.assertEqual(words.words, [{'word': '123', 'tag': 35}, {'word': 'seattle', 'tag': 31}, {'word': 'washington', 'tag': 32}])
        words = Words("12 W Main Ave. POB 10, Seattle, WA", stopwords=True)
        self.assertEqual(words.words, [{'word': '12', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': '10', 'tag': 35}, {'word': 'seattle', 'tag': 31}, {'word': 'washington', 'tag': 32}])
        words = Words("12 W Main Ave. POB 10 Seattle, WA", stopwords=True)
        self.assertEqual(words.words, [{'word': '12', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': '10', 'tag': 35}, {'word': 'seattle', 'tag': 31}, {'word': 'washington', 'tag': 32}])
    ...
    def test_278(self):
        ...
        self.assertEqual(words.words, [{'word': '12', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'department 3', 'tag': 36}, {'word': 'seattle', 'tag': 31}, {'word': 'washington', 'tag': 32}])
        words = Words("12 W Main Ave., Dept 3 Seattle, WA", stopwords=True)
        self.assertEqual(words.words, [{'word': '12', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'department 3', 'tag': 36}, {'word': 'seattle', 'tag': 31}, {'word': 'washington', 'tag': 32}])
    ...
    def test_279(self):
        ...
        self.assertEqual(words.words, [{'word': '12', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'department 3', 'tag': 36}, {'word': 'seattle', 'tag': 31}, {'word': 'washington', 'tag': 32}, {'word': '98607', 'tag': 34}])
        words = Words("12 W Main Ave., Dept 3, Seattle, WA, 98607", stopwords=True)
        self.assertEqual(words.words, [{'word': '12', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'department 3', 'tag': 36}, {'word': 'seattle', 'tag': 31}, {'word': 'washington', 'tag': 32}, {'word': '98607', 'tag': 34}])
        words = Words("12 W Main Ave., Dept 3, Seattle, WA 98607-1234", stopwords=True)
        self.assertEqual(words.words, [{'word': '12', 'tag': 27}, {'word': 'west', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'avenue', 'tag': 30}, {'word': 'department 3', 'tag': 36}, {'word': 'seattle', 'tag': 31}, {'word': 'washington', 'tag': 32}, {'word': '98607-1234', 'tag': 34}])
    ...
    def test_285(self):
        ...
        self.assertEqual(words.words, [{'word': '12', 'tag': 27}, {'word': 'east', 'tag': 28}, {'word': 'main', 'tag': 29}, {'word': 'street', 'tag': 30}, {'word': 'seattle', 'tag': 31}, {'word': 'washington', 'tag': 32}])
        words = Words("12 Main st. e., Seattle, WA", stopwords=True)
        self.assertEqual(words.words, [{'word': '12', 'tag': 27}, {'word': 'main', 'tag': 29}, {'word': 'street', 'tag': 30}, {'word': 'east', 'tag': 28}, {'word': 'seattle', 'tag': 31}, {'word': 'washington', 'tag': 32}])
